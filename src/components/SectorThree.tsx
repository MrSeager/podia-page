...
//Images
import Img from '../images/pexels-teono123-no-18036-88476.jpg';
import ImgTwo from '../images/pexels-designecologist-1779487.jpg';
        ...
        <Container>
            <Row>
                ...
                <Col lg={{ span: 6, order: 3 }} xs={{ span: 12, order: 2 }} className='py-3 mx-auto'>
                    <Image fluid src={Img} alt='image' className='rounded rounded-3 border border-2' />
                </Col>
                ...
                <Col lg={{ span: 6, order: 5 }} xs={{ span: 12, order: 6 }} className='py-3 mx-auto'>
                    <Image fluid src={ImgTwo} alt='image' className='rounded rounded-3 border border-2' />
                </Col>
